...
const ERROR_MAP: [RegExp, string, string][] = [
  ...
  [/execution reverted: NotStarted/i, "not_started", "Campaign has not started yet"],
  [/execution reverted: Ended/i, "ended", "Campaign has already ended"],
  [/execution reverted: SoldOut/i, "sold_out", "All badges have been minted"],
  [/execution reverted: AlreadyClaimed/i, "already_claimed", "You have already claimed this badge"],
  [/execution reverted: SoulboundTransfer/i, "soulbound_transfer", "Soulbound badges cannot be transferred"],
  [/execution reverted: InvalidWindow/i, "invalid_window", "Invalid claim window"],
  [/execution reverted: InvalidSupply/i, "invalid_supply", "Invalid supply configuration"],
  ...
  [/campaign.*not.*found|not found/i, "not_found", "Campaign not found"],
